...
<aside>
  ...
  <nav>
    ...
    <a href="direct_packages.php" class="ni active"><?=svgIcon('box')?> بسته‌های فروش مستقیم</a>
    <a href="direct_orders.php" class="ni"><?=svgIcon('cart')?> سفارش‌های مستقیم <?php if($pendingOrders>0):?><span class="pb"><?=$pendingOrders?></span><?php endif;?></a>
...
<main>
  <div class="topbar">
    <div class="pg-title"><?=svgIcon('box')?> بسته‌های فروش مستقیم</div>
    <button class="btn bp" onclick="openAdd()"><?=svgIcon('plus')?> بسته جدید</button>
  </div>
  <div class="content">
...
<div class="mbg" id="pkgM">
  <div class="modal">
    <div class="mh"><div class="mt" id="pkgTitle"><?=svgIcon('plus')?> بسته جدید</div><button class="mc" onclick="closeM()" title="بستن">✕</button></div>
